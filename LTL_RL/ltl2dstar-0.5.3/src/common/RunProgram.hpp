...
public:
  ...
  /** Get details about the invocation */
  std::string getInvocationDetails() {
    return _invocation_details;
  }
...
private:
  ...
  // a prepared string explaining the invokation details
  std::string _invocation_details;
};
