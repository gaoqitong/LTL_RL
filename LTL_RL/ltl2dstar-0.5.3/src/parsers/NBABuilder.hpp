...
public:
   ...
   */
  void setStartState(std::size_t state) {
   ...
   */
  void setFinal(std::size_t state, bool value=true) {
...
private:
  ...
  typedef std::map<name_t, std::size_t> name2state_map_t;
