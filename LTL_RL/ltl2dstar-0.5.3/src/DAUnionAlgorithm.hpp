...
struct UnionAcceptanceCalculator<RabinAcceptance> {
   ...
   */
  signature_ptr calculateAcceptance(std::size_t da_state_1,
                                    std::size_t da_state_2) {
  ...
  std::size_t _acc_size_1, _acc_size_2;
};
...
public:
  ...
  struct UnionState {
    ...
    UnionState(std::size_t da_state_1_,
	       std::size_t da_state_2_,
...
private:
   ...
   */
  UnionState_ptr createState(std::size_t da_state_1,
			     std::size_t da_state_2) {
