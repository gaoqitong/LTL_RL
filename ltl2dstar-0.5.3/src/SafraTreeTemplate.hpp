...
public:
  ...
  void setRenameable(std::size_t name, bool flag=true) { _renameableNames.set(name, flag); }

  /** Get the 'renameable' flag for a name */
  bool isRenameable(std::size_t name) { return _renameableNames.get(name); }

  /** Set the 'restricted' flag for a name */
  void setRestricted(std::size_t name, bool flag=true) { _restrictedNames.set(name, flag); }

  /** Get the 'restricted' flag for a name */
  bool isRestricted(std::size_t name) { return _restrictedNames.get(name); }
